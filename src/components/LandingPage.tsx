...
export default function LandingPage() {
  return (
    <div className="flex items-center justify-center h-80 bg-blue-600 w-full overflow-x-hidden">
      <motion.div
      ...
      >
        <h1 className="text-white text-4xl md:text-6xl font-bold mb-8 px-60">
