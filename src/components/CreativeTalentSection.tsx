    ...
    <section className="py-12 bg-gray-50 md:pl-4 overflow-x-hidden">
      <div className="container mx-auto flex flex-col lg:flex-row items-center md:ml-20">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <div className="relative md:h-[590px] h-[400px] md:w-[530px] w-full pt-10 rounded-lg p-6 sm:mb-3 ">
            <img className="w-full mt-9 h-full object-cover sm:ml-[68px] sm:mr-8" src="/pic-09.png" alt="Arjun Mehta" />
          </div>
        </motion.div>
      </div>
    </section>
