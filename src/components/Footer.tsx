...
function Footer() {
  ...
  return (
    <motion.footer
      ...
      animate="visible"
      variants={fadeIn}
      className="bg-white text-gray-800 border-t border-gray-200 px-6 sm:px-12 lg:px-28"
    >
      ...
      <div className="container mx-auto px-4 py-6 border-t border-[#192138c9] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Get in Touch */}
        <div className="ml-28 text-center transform translate-x-[0px]">
        ...
        {/* Social Media */}
        <div>
          <h5 className="text-lg font-semibold mb-4 text-[#908134] transform translate-x-[250px]">SOCIAL MEDIA</h5>
          <ul className="flex space-x-4 text-center transform translate-x-[250px] ml-2">
            <li>
