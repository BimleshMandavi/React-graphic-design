...
function Footer() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:pr-12 py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
        {/* Column 1 */}
        ...
        {/* Column 5 */}
        <div className="cursor-pointer sm:transform sm:translate-x-[160px] hidden sm:flex sm:flex-col sm:mr-32">
