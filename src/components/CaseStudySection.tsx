...
const CaseStudySection = () => {
  return (
    <section className="bg-[#070324] py-8 sm:py-16 px-4 sm:px-6 lg:px-8 text-white mt-20">
      <div className="max-w-8xl mt-8 mx-auto">
        {/* Image Section */}
        <div className="flex justify-center mb-8 sm:mb-12">
          <img className="w-[500px] sm:w-[600px] md:w-[700px]" src="/pic-12.png" />
        </div>

        {/* Logos Section */}
        <div className="flex flex-wrap justify-center mt-10 items-center gap-12 sm:gap-24 mb-8 sm:mb-12 cursor-pointer">
          <img src="/assets/park+.png" alt="Park+" className="w-24 sm:w-28" />
          <img src="/assets/piramal-new.svg" alt="Piramal" className="w-24 sm:w-28" />
          <img src="/assets/adani_logo.png" alt="Adani" className="w-24 sm:w-28" />
          <img src="/assets/Screenshot 2025-01-04 145058.png" alt="RVshare" className="w-24 sm:w-28" />
          <img src="/assets/apollo247.svg" alt="Apollo 247" className="w-24 sm:w-28" />
        </div>
