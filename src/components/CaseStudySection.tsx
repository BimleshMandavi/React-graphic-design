  ...
  return (
    <section className="bg-[#070324] py-8 sm:py-16 px-4  lg:px-8 text-white mt-20">
      <div className="max-w-8xl mt-8 sm:ml-20">
        ...
        {/* Logos Section */}
        <div className="flex flex-wrap justify-center mt-10 items-center sm:gap-36 gap-10 mb-8 sm:mb-12 cursor-pointer">
          <img
            src="/assets/park+.png"
            alt="Park+"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-12 items-center">
          ...
          >
            <img
              src="/pic-10.png"
              alt="Tops Case Study"
              className="rounded-lg shadow-lg w-[400px] sm:w-[490px] md:w-[530px] h-auto sm:mr-8"
            />
          </motion.div>
        </div>
      </div>
