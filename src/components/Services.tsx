  ...
  return (
    ...
    >
      <div className="container mx-auto">
        <motion.h2
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-start text-black mb-12"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
          {items.slice(0, visibleCount).map((item, index) => (
            <motion.div
              key={index}
              className="bg-white p-6 sm:p-8 rounded-lg flex flex-col border-2 border-[#192138c9]"
