...
export default function ZeptoCard() {
  return (
    <div className="flex items-center justify-center h-auto mt-20 mx-4 sm:mx-8 md:mx-24">
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col items-center md:items-start w-full">
          <img className="rounded-lg pr-10" src="/pic-14.png" alt="Sanskruti Verma" />
        ...
        {/* Right Section */}
        <div className="text-gray-700 text-center md:text-left bg-white p-6 shadow-lg rounded-lg w-full md:w-auto">
          <p>
